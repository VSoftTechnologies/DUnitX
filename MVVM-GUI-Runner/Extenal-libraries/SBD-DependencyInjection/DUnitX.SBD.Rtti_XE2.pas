...
begin
  Result := DUnitX.SBD.Rtti_XE2.IsManaged(Handle);
end;
...
begin
  ...
  if ReturnType <> nil then
    Result := DUnitX.SBD.Rtti_XE2.Invoke(code, argList, CallingConvention, ReturnType.Handle, IsStatic)
  else if IsConstructor then
    Result := DUnitX.SBD.Rtti_XE2.Invoke(code, argList, CallingConvention, parList[0].ParamType.Handle, IsStatic)
  else
    Result := DUnitX.SBD.Rtti_XE2.Invoke(code, argList, CallingConvention, nil); // Invoke returns TValue.Empty
end;
...
begin
  ...
  if ReturnType <> nil then
    ...
    Result := DUnitX.SBD.Rtti_XE2.Invoke(code, argList, CallingConvention, cls.ClassInfo, IsStatic)
  else
    Result := DUnitX.SBD.Rtti_XE2.Invoke(code, argList, CallingConvention, nil);
end;
...
begin
  ...
  if ReturnType <> nil then
    Result := DUnitX.SBD.Rtti_XE2.Invoke(CodeAddress, argList, CallingConvention, ReturnType.Handle, IsStatic)
  else
    Result := DUnitX.SBD.Rtti_XE2.Invoke(CodeAddress, argList, CallingConvention, nil);
end;
...
begin
  ...
  if ReturnType <> nil then
    Result := DUnitX.SBD.Rtti_XE2.Invoke(meth.Code, argList, CallingConvention, ReturnType.Handle, False) // not static
  else
    Result := DUnitX.SBD.Rtti_XE2.Invoke(meth.Code, argList, CallingConvention, nil);
end;
...
begin
  ...
  if ReturnType <> nil then
    Result := DUnitX.SBD.Rtti_XE2.Invoke(code, argList, CallingConvention, ReturnType.Handle)
  else
    Result := DUnitX.SBD.Rtti_XE2.Invoke(code, argList, CallingConvention, nil);
end;
