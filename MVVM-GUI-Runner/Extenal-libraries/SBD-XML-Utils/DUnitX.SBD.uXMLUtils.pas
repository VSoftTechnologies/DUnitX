...
var
  ...
  begin
    result := DUnitX.SBD.uXMLUtils.ReadWord( psEncodedValue, StartPos, Length, MinVal, MaxVal, Val1);
  end;
...
var
  ...
  function ReadWord( StartPos, Length: integer; MinVal, MaxVal: word; var Val1: word): boolean;
  begin
    result := DUnitX.SBD.uXMLUtils.ReadWord( sEncoded, StartPos, Length, MinVal, MaxVal, Val1);
  end;
