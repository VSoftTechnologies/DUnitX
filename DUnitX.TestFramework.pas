...
{$ENDIF}
  ...
  public
    class var
      ...
      //Defaults to Pause
      ExitBehavior : TDUnitXExitBehavior;
...
class constructor TDUnitXOptions.Create;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if not TDUnitXOptions.HideBanner then
  ...
  begin
    ...
    begin
      ...
      if TDUnitXOptions.ShowUsage then
      begin
        consoleWriter := TDUnitXIoC.DefaultContainer.Resolve<IDUnitXConsoleWriter>;
        ShowUsage(consoleWriter);
        Halt(EXIT_OK);
...
class destructor TDUnitXOptions.Destroy;
begin
  TDUnitXOptions.Run.Free;
end;
