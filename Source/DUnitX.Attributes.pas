...
type
  ...
  /// <summary>
  ///   Base class for all Test Case Generator Attributes.   
  /// </summary>
  /// <remarks>
  ///   <para>
  ...
  ///     CustomTestCaseGeneratorAttribute and returns an empty TestCaseInfoArray,
  ///     then no test will be shown for the method.
  ///   </para>
  /// </remarks>
  CustomTestCaseGeneratorAttribute = class abstract(TCustomAttribute)
  protected
  ...
  protected
    ...
    constructor InternalCreate(const ACaseName : string; const AValues : string; const ASeparator : string = ','; const ATrimValues : boolean = false);
  public
  ...
  /// </summary>
  NamedTestCaseAttribute = class(TestCaseAttribute)
  protected
  public
  ...
  /// <summary>
  /// TestCaseSource Attribute allows you to specify a static class
  ...
  private
    ...
    FSourceClass : TClass;
  public
    constructor Create(const sourceMethodName : string);overload;
    constructor Create(const sourceClass : TClass; const sourceMethodName : string);overload;
...
constructor TestCaseAttribute.InternalCreate(const ACaseName: string; const AValues: string;const ASeparator : string; const ATrimValues : boolean);
var
  i: Integer;
  l : integer;
...
constructor TestCaseAttribute.Create(const AValues, ASeparator: string; const ATrimValues: boolean);
begin
  InternalCreate('', AValues, ASeparator, ATrimValues);
end;
...
{ NamedTestCaseAttribute }

constructor NamedTestCaseAttribute.Create(const AValues, ASeparator: string; const ATrimValues: boolean);
begin
  inherited InternalCreate('', AValues, ASeparator, ATrimValues);
end;

{ TestCaseSourceAttribute }

constructor TestCaseSourceAttribute.Create(const sourceMethodName: string);
begin
  FSourceMethodName := sourceMethodName;
end;

constructor TestCaseSourceAttribute.Create(const sourceClass: TClass; const sourceMethodName: string);
begin
