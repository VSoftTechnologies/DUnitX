...
type
  ...
  public class var
    FActiveRunners : TDictionary<Cardinal,TDUnitXTestRunner>;
  private
  ...
  protected
    ...
    //internals
    procedure DoDiscoverFixtureClasses;
  ...
  public
    ...
    procedure Log(const logType : TLogType; const msg : string);
  end;
...
begin
  ...
  FActiveRunners := TDictionary<Cardinal,TDUnitXTestRunner>.Create;
...
procedure TDUnitXTestRunner.DoDiscoverFixtureClasses;
var
...
begin
  ...
  begin
    try
      ...
      begin
        try
           logger.OnLog(TLogType.ltError,'Error in OnEndSetupEvent : ' + e.Message);
        except
          on e : Exception do
      ...
      try
        ...
        begin
          try
            ...
            on e : Exception do
            begin
              Log(TLogType.ltError,'Error in Fixture SetupError : ' + fixture.Name + ' : ' + e.Message);
              Log(TLogType.ltError,'Skipping Fixture.');
              System.Continue;
            end;
          end;
        end;
          ...
          begin
            ...
            begin
              try
                ...
                begin
                  ...
                  Log(TLogType.ltError,'Error running test Setup method : ' + e.Message);
                  Log(TLogType.ltError,'Skipping test.');
                  System.Continue;
                end;
              end;
            end;
            ...
            try
              try
                ...
                begin
                  Log(TLogType.ltError,'Test failed : ' + test.Name + ' : ' + e.Message);
                ...
                begin
                  Log(TLogType.ltWarning,'Test warning : ' + test.Name + ' : ' + e.Message);
                ...
                on e : Exception do
                begin
                  Log(TLogType.ltError,'Test Error : ' + test.Name + ' : ' + e.Message);
...
procedure TDUnitXTestRunner.Log(const logType: TLogType; const msg: string);
var
  logger : ITestLogger;
begin

  if logType >= TDUnitX.CommandLine.LogType then
  begin
    for logger in FLoggers do
