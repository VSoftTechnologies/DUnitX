...
procedure TDUnitXConsoleLogger.OnTestFailure(const threadId: Cardinal; Failure: ITestResult);
begin

end;

procedure TDUnitXConsoleLogger.OnLog(const logType: TLogType; const msg: string);
begin
...
begin
  ...
  FConsoleWriter.WriteLn('**********************************************************************');
  FConsoleWriter.WriteLn('               DUnitX - (c) 2012 Vincent Parrett                      ');
